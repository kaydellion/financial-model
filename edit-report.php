...
<main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Edit Report</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li class="current">Edit Report</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
...
<!-- Basic Layout -->
   <div class="section-content">
               <div class="row">
                    ...
                    <div class="mb-3 form-group" id="subcategory-container" style="display:block;">
...
?>
         ...
         <h6>Pricing and File Upload</h6>
                    ...
                    <div class="mb-3 form-group" id="price-field" style="display:<?php echo ($pricing == 'paid') ? 'block' : 'none'; ?>;">
...
<?php } ?></div>
   ...
   <select class="form-select" id="documentSelect"  onchange="handleDocumentSelect(this)">
...
<div class="mb-3 form-group" id="methodologyBox" style="display: <?php echo ($guidanceType=='methodology') ? 'block' : 'none'; ?>;">
