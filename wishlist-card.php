...
?>
  ...
  <?php endif; ?>
        ...
        <input type="hidden" name="remove_wishlist_id" value="<?php echo $report_id; ?>">
        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
        <button class="btn-remove" type="submit" name="remove_wishlist" aria-label="Remove from wishlist">
